...
const stringFieldSchema = (fieldName: string, t: (key: string, params?: any) => string) =>
    z.string()
        .min(1, { message: t('validators.required', { field: fieldName }) })
        .regex(/^[A-Za-z\s]+$/, { message: t('validators.alphabetsOnly', { field: fieldName }) });


const alphanumeric = (fieldName: string, t: (key: string, params?: any) => string) =>
    z.string()
        .min(1, { message: t('validators.required', { field: fieldName }) })
...
const mobileFieldSchema = (fieldName: string, t: (key: string, params?: any) => string, length?: number) =>
    z.string()
        .min(1, { message: t('validators.required', { field: fieldName }) })
...
const stringField2Schema = (fieldName: string, t: (key: string, params?: any) => string) =>
    z.string({
...
export const getGlobalSchema = (t: any) => ({
