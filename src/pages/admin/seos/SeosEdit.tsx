...
import { BsArrowLeft, Button, Dialog, FaSave, Image, InputText, InputTextarea, IoIosArrowBack, IoIosArrowForward, Stepper, StepperPanel, Toast } from '../../../sharedBase/globalImports';
...
export default function SeosEdit() {
  ...
  const { showDialog, setShowDialog, isFieldHidden, handleCloseDialog, removeEmptyFields, prepareObject }
    = useEditPage<Seo>({
      props: {
        id: id,
