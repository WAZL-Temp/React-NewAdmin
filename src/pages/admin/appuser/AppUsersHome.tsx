...
import { useNavigate, useTranslation, Button, Card, Carousel, CgEye, CiShoppingCart, FaArrowRight, FaRegComment, GoInbox, Image, MdOutlineLocationOn, RiFileEditLine } from '../../../sharedBase/globalImports';
