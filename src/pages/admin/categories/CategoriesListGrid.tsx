...
import { CategoriesService, categoryPageDataService } from "../../../core/service/categories.service";
import Loader from "../../../components/Loader";
import { useListGridPage } from "../../../hooks/useListGridPage";

export default function CategoriesListGrid() {
    ...
    const userService = CategoriesService();
    const query = useListQuery<Category>(userService);
    const {
        ...
        sortField, sortOrder }
        = useListGridPage<typeof query, Category>({
            query: query,
            props: {
                initialFilterValue: '',
                ...
                typeName: typeName,
                service: userService,
                pageGridService: categoryPageDataService,
            }
        });
...
const columnsConfigDefault = useMemo(() =>[
    ...
    if (roleData && hasAccess(roleData, "Export")) {
        items.push({
            ...
            command: () => exportToExcel(userService, globalFilterValue || '', 'Category')
        });
    }
                        ...
                        <div className="hidden lg:flex items-center space-x-2 flex-wrap  bg-[var(--color-white)] text-[var(--color-dark)]">
                            ...
                            {hasAccess(roleData, "Export") && (
                                <Button
                                    ...
                                    onClick={() => exportToExcel(userService, globalFilterValue || '', 'Category')}
