...
const numberFromStringField = (fieldName: string, t: TransFn, minValue: number, maxValue: number) =>
...
export const appUserTestValidate = (t: TransFn) => ({
    ...
    gstOtp: stringAlphanumeric(t('appUserTests.columns.fields.gstOtp'), t, 1, 100),
    ...
    totalPlot: numberFromStringField(t('appUserTests.columns.fields.totalPlot'), t, 1, 100),
    reportedTo: requiredStringField(t("appUsers.columns.fields.reportedTo"), t, 1, 100),
    reportedBy: requiredStringField(t("appUsers.columns.fields.reportedBy"), t, 1, 100),
    appUserName: stringOnlyAlphabets(t('appUserTests.columns.fields.appUserName'), t, 1, 100),
